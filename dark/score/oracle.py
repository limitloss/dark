...
# -*- coding: utf-8 -*-
"""
Oracle Model used for calculating the IG-score
"""
...
class ORACLE(nn.Module):
    def __init__(self,width,cwidth):
        ...
        layer = Maxout2d(in_channels=442+width, out_channels=cwidth, pool_size=3)
    ...
    def forward(self, x, x2):
        ...
        x = self.embed(x)
        xx = torch.empty((0, self.width)).type(x.type())
